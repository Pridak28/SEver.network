 ...
 * DISABLED TO PREVENT CONFLICTS WITH MAIN LOADING SYSTEM
 */

// Disable this system to prevent conflicts with script-2.js loading animation
console.log(
  "login-animations.js: DISABLED to prevent loading animation conflicts"
);

// Comment out the entire system
/*
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createLoadingAnimation() {
    // Remove any existing overlays and skip buttons from the entire document
    document.querySelectorAll("#loadingOverlay").forEach((el) => el.remove());
    document.querySelectorAll(".login-skip-btn").forEach((el) => el.remove());
